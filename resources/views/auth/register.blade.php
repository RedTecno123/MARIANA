...
<div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-200 rounded-lg shadow-lg">
    ...
    <input type="text" class="boder boder-gray-200 rounded-md bg-gray-200 w-full 
    ...
    <input type="email" class="boder boder-gray-200 rounded-md bg-gray-200 w-full 
    ...
    <input type="password" class="boder boder-gray-200 rounded-md bg-gray-200 w-full 
